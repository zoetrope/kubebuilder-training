...
var _ = Describe("MarkdownView controller", func() {
	...
	BeforeEach(func() {
		err := k8sClient.DeleteAllOf(ctx, &viewerv1.MarkdownView{}, client.InNamespace("test"))
...
func newMarkdownView() *viewerv1.MarkdownView {
	return &viewerv1.MarkdownView{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "sample",
			Namespace: "test",
		},
		Spec: viewerv1.MarkdownViewSpec{
